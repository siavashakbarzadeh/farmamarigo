 ...
 <tr>
             ...
             <tr style='border:0;'>
                 <td valign="top" style="border:0;border-collapse: collapse;">
                     <table width="800" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            bgcolor="#ffffff" style="border:0;background-color: #ffffff;border-spacing: 0;">
                         <!--start space height -->
                         <tbody style='border:0;'>
                         <tr style='border:0;'>
                             <td height="10" style="border:0;border-collapse: collapse;"></td>
                         </tr>
                         <!--end space height -->
                         <tr style='border:0;'>
    ...
    <div class="card text-center">
        <div class="card-header">
            <h2>Benvenuto nell’area riservata del sito internet Marigo Italia!</h2>
        </div>
        <div class="card-body">
            <p class="card-title">Spett.le {{ $name }}</p>
            <p class="card-text">
                la Marigo Italia ha attivato un nuovo servizio per fidelizzare sempre di più la propria Clientela.
            </p>
            <p>
                Anche Lei, in quanto nostro affezionato Cliente, potrà accedere all’area riservata del nostro sito Internet e usufruire di una serie di vantaggi, come effettuare ordini rapidamente e in sicurezza, verificare lo storico dei Suoi ordini, visionare listini dei produttori, e altro ancora.
            </p>
            <br>
            <p>
            ...
            <br>
            <p>
                Nome utente: @if($code!=null) {{ $code }}  o @endif {{$email}}
            </p>
            <p>
                Password: {{ $password }}
            </p>
            <br>
            <p>
                Una volta entrato nella Sua area riservata, potrà modificare la Sua password.
            </p>
            <p>
                Nel caso avesse bisogno di supporto per il primo accesso, può inviare una richiesta all'indirizzo: pdileva@marigoitalia.it
            </p>
            <p>
                La ringraziamo della Sua disponibilità e ci auguriamo che i nuovi servizi possano contribuire a rinsaldare la stretta e cordiale collaborazione anche nei prossimi anni.
            </p>
        </div>
        <br>
                ...
                <tr style='border:0;'>
                    <td valign="top" style="border:0;border-collapse: collapse;">
                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                            ...
                            <tbody style='border:0;'>
                            <tr style='border:0;'>
                                <td height="20" style="border:0;border-collapse: collapse;"></td>
                            </tr>
                            <!--end space height -->
                            <tr style='border:0;'>
                                <td valign="top" align="center" style="border:0;border-collapse: collapse;">
                                    <!-- start logo footer and address -->
                                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"
                                           class="container" style="border:0;border-spacing: 0;">
                                        <tbody style="border:0;">
                                        <tr style="border:0;">
                                            <td valign="top" style="border:0;border-collapse: collapse;">
                                                <!--start icon navigation -->
                                                <table width="100%" border="0" align="center" cellpadding="0"
                                                       cellspacing="0" style="border:0;border-spacing: 0;">
                                                    <tbody style="border:0;">
                                                    <tr style="border:0;">
                                                                ...
                                                                <tr style='border:0;'>
                                                                    <td align="left" valign="middle"
                                                                        ...
                                                                        <table width="100%" border="0" align="left"
                                                                               ...
                                                                               class="col-2" style="border:0;border-spacing: 0;">
                                                                            <tbody style='border:0;'>                                                                                                    <tr style="border:0;">
                                                                                <td height="10"
                                                                                    style="border:0;border-collapse: collapse;">
                                                                                </td>
                                                                            </tr>
                                                                        ...
                                                                        <table align="center" style='border:0;'>
                                                                            <tbody style='border:0;' align="center">
                                                                            <tr style="border:0;" align="center">
                                                                                <td valign="top" align="center" style="display:block;border:0;font-size: 13px;line-height: 15px; text-align: center; font-family: Arial,Tahoma, Helvetica, sans-serif;color: #fff;font-weight: normal;border-collapse: collapse;">
                            ...
                            <!-- start space height -->
                            <tr style="border:0;">
                                <td height="10" valign="top" style="border:0;border-collapse: collapse;"></td>
                            </tr>
                            <!-- end space height -->
                            </tbody>
                        </table>
                ...
                <tr style='border:0;'>
                    <td align="center" valign="top" class="fix-box" style="border:0;border-collapse: collapse;">
                        ...
                        <table width="800" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                            ...
                            <!-- end space height -->
                            <tr style="border:0;">
                                <td align="center" valign="top" style="border:0;border-collapse: collapse;">
                                    <table width="800" align="center" border="0" cellspacing="0" cellpadding="0"
                                           class="container" style="border:0;border-spacing: 0;">
                                        <tbody style="border:0;">
                                        <tr style="border:0;">
                                            <td valign="top" align="center" style="border:0;border-collapse: collapse;">
                                                <table width="560" align="center" border="0" cellspacing="0"
                                                       cellpadding="0" class="container" style="border:0;border-spacing: 0;">
                                                    <tbody style='border:0;'>
                                                    <tr style='border:0;'>
                            ...
                            <!-- start space height -->
                            <tr style='border:0;'>
                                <td height="20" valign="top" style="border:0;border-collapse: collapse;"></td>
                            </tr>
                            <!-- end space height -->
                            </tbody>
                        </table>
