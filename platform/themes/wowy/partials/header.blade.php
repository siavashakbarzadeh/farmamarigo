                ...
                <div class="container">
                    <div class="row align-items-center ">
                            ...
                            <div class="header-info">
                                <ul>
                                    ...
                                    @if (is_plugin_active('ecommerce') && EcommerceHelper::isOrderTrackingEnabled())
                                        <li><i class="fa fa-phone-alt mr-3"></i><a href="tel:+39 0815344611">{{ __('+39 0815344611') }}</a></li>
                                        <li><i class="fa fa-envelope mr-3"></i><a href="">{{ __('info@marigoitalia.it ') }}</a></li>
                                        <li><i class="fa fa-location mr-3"></i><a href="">{{ __('Via Bagnulo, 168 - Piano di Sorrento (NA)') }}</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                        ...
                        @if (is_plugin_active('ecommerce') || is_plugin_active('language'))
                            <div class="d-flex justify-content-end align-items-center col-lg-3 col-xl-3 col-md-3 float-end ">
...
{{--                                    @endif--}}
                                    <div class="header-action-icon-2">
                                            ...
                                            <a class="mini-cart-icon" href="@if(auth('customer')->check()) {{ route('public.cart') }} @else {{ route('customer.login') }} @endif">
