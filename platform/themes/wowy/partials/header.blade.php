...
<header class="header-area header-height-2 {{ $headerStyle }}">
                        ...
                        <div class="header-info header-info-right">
                            <ul>
                                ...
                                @if (is_plugin_active('ecommerce'))
                                    ...
                                    @else
                                        <li><i class="fa fa-user mr-5"></i><a href="{{ route('customer.login') }}">{{ __('LOGIN') }}</a></li>
                                    @endif
                                @endif
                            </ul>
                        </div>
            ...
            <div class="header-wrap header-space-between">
                ...
                @if (is_plugin_active('ecommerce'))
                    <div class="search-style-2">
                        <form action="{{ route('public.fullsearch') }}" method="get">
                            ...
                            <input type="text" name="q" placeholder="{{ __('Search for items…') }}" autocomplete="off" style="border-radius:26px !important;">
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            @endif --}}
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" style="width:4.5em"href="{{ route('public.cart') }}">
                                    <div class="row">
                                        <div class="col-6 text-end"><img style="width: 57%" alt="{{ __('Cart') }}" src="{{ Theme::asset()->url('images/icons/icon-cart.svg') }}"></div>

                                        <div class="col-6"><span class="pro-count blue" style="width: fit-content;background-color: #005BA1;border-radius: 5px;padding: 6px 10px;line-height: 24px; color:white;position: relative;">{{ format_price(Cart::instance('cart')->rawSubTotal() + Cart::instance('cart')->rawTax()) }}</span></div>

                                    </div>

                                </a>
                                {{-- <span class="pro-count blue count-on-header" >{{ format_price(Cart::instance('cart')->rawSubTotal() + Cart::instance('cart')->rawTax()) }}</span> --}}
    ...
    <div class="header-bottom header-bottom-bg-color sticky-bar gray-bg" style="background-color:white !important; color:black;padding-top:20px">
        <div class="container">
                    ...
                    <div class="mobile-header-info-wrap mobile-header-border">
                        @if (is_plugin_active('ecommerce'))
                            <div class="single-mobile-header-info">
                                @if (auth('customer')->check())
                                    <a href="{{ route('customer.overview') }}"><i class="fa fa-user mr-5"></i> Bentornato! {{ auth('customer')->user()->name }}</a>
                                @else
