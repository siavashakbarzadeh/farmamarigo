...
{{--    </div>--}}
    ...
    <div class="widget mt-3 row">
        <div class="container">
            ...
            @endphp
            <a class="btn btn-danger col-12" style="font-size:small;border-radius:25px; text-transform:none;" href="{{ '/products?categories='.(string)$category }}">{{ __('Cancella filtri') }}</a>
        </div>
    </div>
</div>
