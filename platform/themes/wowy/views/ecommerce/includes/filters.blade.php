...
{{--    </div>--}}
    ...
    <div class="widget mt-3 row">
        <div class="container">
            ...
            @endphp
            <button class="btn btn-sm col-12 clear_filter dib clear_all_filter" style="color:#51b448;background-color:white !important;font-size: small; border-radius: 25px; text-transform: none;" href="{{ URL::current() }}">{{ __('Cancella filtri') }}</button>
        </div>
    </div>
</div>
