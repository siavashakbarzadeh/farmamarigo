                ...
                <div class="col-12">
                    <form action="https://marigolab.it/product-categories/prodotti-consumabili" method="get"
                        ...
                        <input autofocus style="width:100% !important;border-radius: 5px;font-size: smaller;"
                            ...
                            autocomplete="off" style="border-radius:26px !important;">
                    </form>
                </div>
            </div>
        </div>
        @if (count($categories) > 0)
            <div class="col-lg-12 widget-filter-item">
                ...
                <div class="custome-checkbox ps-custom-scrollbar "style="overflow:hidden!important;">
                    ...
                    @endphp
                    @include(Theme::getThemeNamespace() . '::views.ecommerce.includes.filter-product-category',
                        ['categories' => $categories, 'indent' => null]
                    )
                </div>
            </div>
        @endif
