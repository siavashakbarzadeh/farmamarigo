                    ...
                    <div class="product-price primary-color float-left">
                        ...
                        @if (isset($reserved_price))
                            @if ($reserved_price !== $product->price)
                                <ins><span
                                        class="old-price font-md ml-15">{{ format_price($product->price_with_taxes) }}</span></ins>
                                <span class="save-price font-md color3 ml-15"><span
                                        class="percentage-off d-inline-block">{{ get_sale_percentage($product->price, $reserved_price) }}</span>
                                    <span class="d-inline-block">{{ __('Discount') }}</span></span>
                            @endif
                        @endif
