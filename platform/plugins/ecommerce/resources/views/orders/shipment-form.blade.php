    ...
    <div class="pd-all-20 pt10">
            ...
            <div class="flexbox-grid-form-item max-width-220-px">
                <div class="form-group mb-3">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="next-input input-mask-number shipment-form-weight" name="weight"
                            value="{{ $weight }}">
                    </div>
                </div>
            </div>
        ...
        <div class="address-header p-b5">
            ...
            <div class="right"><a href="#"
                    class="hover-tooltip hover-underline color-blue btn-trigger-update-shipping-address">{{ trans('plugins/ecommerce::shipping.edit') }}</a>
            </div>
        </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <th><b>{{ trans('plugins/ecommerce::shipping.packages') }}</b><i
                                                    style="display:block;font-size: xx-small; color: darkgoldenrod"><span
                                                        class="ws-nm">{{ trans('plugins/ecommerce::shipping.warehouse') }}
                                            ...
                                            <th class="text-end">
                                                <b>{{ trans('plugins/ecommerce::shipping.shipping_fee_cod') }}</b><i
                                                    style="display:block;font-size: xx-small;">{{ trans('plugins/ecommerce::shipping.fee') }}</i>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($shipping as $shippingKey => $shippingItem)
                                            @foreach ($shippingItem as $subShippingKey => $subShippingItem)
                                                <tr class="clickable-row" data-key="{{ $shippingKey }}"
                    ...
                    @if (
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="next-input--stylized">
                                ...
                                <input class="next-input next-input--invisible input-mask-number"
    ...
    <div class="modal-footer">
        <div class="flexbox-grid-default flexbox-align-items-center">
            ...
            <div class="flexbox-auto-content">
                <button type="button"
                    class="btn btn-secondary btn-close-shipment-panel">{{ trans('plugins/ecommerce::shipping.cancel') }}</button>
                <button type="button"
                    class="btn btn-primary btn-create-shipment">{{ trans('plugins/ecommerce::shipping.finish') }}</button>
            </div>
        </div>
    </div>
</form>
